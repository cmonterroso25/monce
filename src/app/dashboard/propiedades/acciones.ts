...
export async function crearPropiedad(formData: FormData) {
  ...
  const { data: propiedad, error } = await supabase
    ...
    .insert({
      ...
      niveles: numeroOpcional(formData.get('niveles')),
      dormitorios: numeroOpcional(formData.get('dormitorios')),
      banos: numeroOpcional(formData.get('banos')),
      ...
      area_m2: numeroOpcional(formData.get('area_m2')),
      ...
      comision: numeroOpcional(formData.get('comision')),
